...
public class PigExecutor {
    ...
    /** Logger. */
    private static final Logger LOGGER = LoggerFactory.getLogger(PigExecutor.class);
    ...
    static {
        ...
        try {
            ...
            server.registerJar(PigExecutor.class.getProtectionDomain().getCodeSource().getLocation().getPath());
        } catch (IOException e) {
