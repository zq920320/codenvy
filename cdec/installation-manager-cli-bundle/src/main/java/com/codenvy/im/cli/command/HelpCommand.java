...
public class HelpCommand extends AbstractIMCommand {
    ...
    protected void doExecuteCommand() throws Exception {
        ...
        String value = buildAsciiForm().withEntry(withCyan("build"), "Build a project ")
                                       ...
                                       .withEntry(withCyan("exit"), "Exit of the shell ")
                                       ...
                                       .withEntry(withCyan("im-version"), "Print the list of available latest versions and installed ones")
                                       ...
                                       .withEntry(withCyan("privacy"), "Set privacy of a project ")
                                       ...
                                       .withEntry(withCyan("remote"), "Add or remove remote Codenvy cloud references ")
