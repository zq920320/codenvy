 ...
 */
package com.codenvy.dashboard.benchmark;
...
public class TestCollector
{
    ...
    * Logger.
    */
   protected static final Logger LOG = LoggerFactory.getLogger(TestCollector.class);
   ...
   public void setUp() throws Exception
   {
      ...
      log = context.getLogger(TestCollector.class);
   }
