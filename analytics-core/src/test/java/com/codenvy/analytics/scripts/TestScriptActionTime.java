...
public class TestScriptActionTime extends BaseTest {
    ...
    public void testExecuteScript() throws Exception {
        ...
        // 6m
        events.add(Event.Builder.createRunStartedEvent("user1", "ws1", "project", "type").withDate("2013-01-01")
                        .withTime("19:00:00").build());
        events.add(Event.Builder.createRunFinishedEvent("user1", "ws1", "project", "type").withDate("2013-01-01")
