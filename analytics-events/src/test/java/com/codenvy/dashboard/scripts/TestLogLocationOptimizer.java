...
public class TestLogLocationOptimizer extends BasePigTest {
    ...
    public void testPathsStringGenerationByDate() throws Exception {
        ...
        assertEquals(dir1.getPath() + "," + dir2.getPath(), LogLocationOptimizer.generatePathString(baseDir, "20131231", "20140103"));
    }
    ...
    public void testPathsStringGenerationByDateSameDates() throws Exception {
        ...
        assertEquals(dir1.getPath(), LogLocationOptimizer.generatePathString(baseDir, "20131231", "20131231"));
    }

    @Test(expectedExceptions = IllegalStateException.class)
    public void testPathsStringGenerationByDatesWrongOrder() throws Exception {
        LogLocationOptimizer.generatePathString(baseDir, "20140103", "20131231");
    }

    @Test
    public void testPathsStringGenerationByDatesEmptyResult() throws Exception {
        assertEquals("", LogLocationOptimizer.generatePathString(baseDir, "20131231", "20140103"));
    }
    ...
    public void testPathsStringGenerationByLast10Minutes() throws Exception {
        ...
        assertEquals(dir1.getPath(), LogLocationOptimizer.generatePathString(baseDir, "10"));
    }
    ...
    public void testPathsStringGenerationByLast1440Minutes() throws Exception {
        ...
        assertEquals(dir1.getPath() + "," + dir2.getPath(), LogLocationOptimizer.generatePathString(baseDir, "1440"));
    }
