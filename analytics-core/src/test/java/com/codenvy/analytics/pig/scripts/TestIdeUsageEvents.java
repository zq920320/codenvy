...
public class TestIdeUsageEvents extends BaseTest {
    ...
    public void prepare() throws Exception {
        ...
        events.add(Event.Builder.createIDEUsageEvent("user2@gmail.com", null, null, null, null, null, null)
                                .withDate("2013-01-01").build());
        events.add(Event.Builder.createIDEUsageEvent("user3@gmail.com", null, CodeCompletionsBasedOnIdeUsage.ACTION, CodeCompletionsBasedOnIdeUsage.SOURCE[0], null, null, null)
                                .withDate("2013-01-01").build());
        events.add(Event.Builder.createIDEUsageEvent("user4@gmail.com", null, CodeCompletionsBasedOnIdeUsage.ACTION, CodeCompletionsBasedOnIdeUsage.SOURCE[0], null, null, null)
                                .withDate("2013-01-01").build());
        events.add(Event.Builder.createIDEUsageEvent("user5@gmail.com", null, CodeCompletionsBasedOnIdeUsage.ACTION, CodeCompletionsBasedOnIdeUsage.SOURCE[0], null, null, null)
                                .withDate("2013-01-01").build());
        events.add(Event.Builder.createIDEUsageEvent("user5@gmail.com", "testWs", null, OpenProjectAction.SOURCE[0], "testProject", null, null)
                                .withDate("2013-01-01").withTime("11:00:00").build());
        events.add(Event.Builder.createIDEUsageEvent("user5@gmail.com", "testWs", null, BuildAction.SOURCE[0], "testProject", "spring", null)
