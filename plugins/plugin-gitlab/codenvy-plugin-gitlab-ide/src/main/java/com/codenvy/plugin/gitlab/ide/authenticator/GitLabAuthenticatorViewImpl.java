 ...
 */
public class GitLabAuthenticatorViewImpl implements GitLabAuthenticatorView {

    private DialogFactory              dialogFactory;
    private GitLabLocalizationConstant locale;
    ...
    @Inject
    public GitLabAuthenticatorViewImpl(DialogFactory dialogFactory,
