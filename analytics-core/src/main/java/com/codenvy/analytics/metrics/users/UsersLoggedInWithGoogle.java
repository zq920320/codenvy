...
public class UsersLoggedInWithGoogle extends AbstractActiveEntities {
    public static final String GOOGLE = "google";

    public UsersLoggedInWithGoogle() {
        super(MetricType.USERS_LOGGED_IN_WITH_GOOGLE, MetricType.USERS_LOGGED_IN_TYPES, USER);
    }
    ...
    public Context applySpecificFilter(Context clauses) throws IOException {
        ...
        builder.put(MetricFilter.EXISTS, new String[]{GOOGLE});
