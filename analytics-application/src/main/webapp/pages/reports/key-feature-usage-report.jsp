...
<html lang="en">
<head>
    <title>Key Feature Action Usage Report</title>
...
<jsp:include page="/inclusions/top-menu/top-menu.jsp">
    ...
    <jsp:param name="selectedMenuItemId" value="topmenu-reports-key_feature_usage_report"/>
</jsp:include>
        ...
        <div>
            ...
            <div class="hero-unit">
                <div class="single-column-gadget">
                    <div class="view">
                        <div class="tables">
                            <div id="keyFeatureUsageReport"></div>
                        </div>
                    </div>
                </div>
            </div> 
