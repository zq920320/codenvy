...
public class TopFactorySessionsBy30Days extends AbstractTopSessions {

    public TopFactorySessionsBy30Days() {
        super(MetricType.TOP_FACTORY_SESSIONS_BY_30_DAYS, PassedDaysCount.BY_30_DAYS);
    }
