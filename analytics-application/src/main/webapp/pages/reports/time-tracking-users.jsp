...
<html lang="en">
<head>
    <title>Time tracking by users</title>
        ...
        <div>
            <div class="well topFilteringPanel">
                <div id="metric" class="btn-group metric-btns left" targetWidgets="_all">
                    ...
                    <button class="btn command-btn" default value="time-tracking-users.jsp">Users</button>
            ...
            <div class="hero-unit">
                <div class="single-column-gadget">
                    <div class="view">
                        <div class="tables">
                            <div class="item" id="timeTrackingUsers"></div>
                        </div>
                    </div>
                </div>
            </div>
