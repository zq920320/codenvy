 ...
 */
public class ProductUsageTimeTopUsersBy60DayMetric extends ScriptBasedMetric {

    ProductUsageTimeTopUsersBy60DayMetric() {
        super(MetricType.PRODUCT_USAGE_TIME_TOP_USERS_BY_60DAY);
    }
