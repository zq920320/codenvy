...
public class ReturnedActiveWsMetric extends CalculatedMetric {

    ReturnedActiveWsMetric() {
        super(MetricType.RETURNED_ACTIVE_WS, MetricType.ACTIVE_WS);
    }
    ...
    public String getDescription() {
        return "The number of returned active workspaces";
    }
