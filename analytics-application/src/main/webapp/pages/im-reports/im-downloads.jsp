...
<jsp:include page="/inclusions/top-menu/top-menu.jsp">
    ...
    <jsp:param name="selectedMenuItemId" value="topmenu-im-downloads"/>
</jsp:include>
        ...
        <div>
                ...
                <div id="filter-by" class="left" targetWidgets="_all">
                    ...
                    <div class="collabsiblePanelBody">
                        <table>
                            ...
                            <tr>
                               <td><label for="input-user">Artifact:</label></td>
                               <td><div class="filter-item">
                                   <input type="text" id="input-artifact" name="artifact" class="text-box" />
                               </div></td>
                            </tr>
                            <tr>
                               <td><label for="input-user">Version:</label></td>
                               <td><div class="filter-item">
                                   <input type="text" id="input-version" name="version" class="text-box" />
                               </div></td>
                            </tr>
                            <tr>
            ...
            <div class="hero-unit">
                <div class="single-column-gadget">
                    <div class="view">
                        <div class="tables">
                            <div class="item" id="imDownloadStatisticsOverview"></div>
                            <div class="item" id="imDownloadStatistics"></div>
                        </div>
                    </div>
                </div>
            </div>
