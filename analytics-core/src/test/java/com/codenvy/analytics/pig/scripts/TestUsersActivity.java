...
public class TestUsersActivity extends BaseTest {
    ...
    public void prepare() throws Exception {
        ...
        events.add(Event.Builder.createWorkspaceCreatedEvent("ws2", "wsid2", "user2@gmail.com").withDate("2013-01-01").build());
        ...
        events.add(Event.Builder.createIDEUsageEvent("user1@gmail.com",
                                                     "ws1",
                                                     "action1",
                                                     "src1",
                                                     "project1",
        ...
        events.add(Event.Builder.createIDEUsageEvent("user2@gmail.com",
                                                     "ws2",
                                                     "action2",
                                                     "src2",
                                                     "project2",
        ...
        events.add(Event.Builder.createIDEUsageEvent("user3@gmail.com",
                                                     null,
                                                     null,
                                                     null,
                                                     "project2",
