 ...
 */
public class ProductUsageTimeTopCompaniesBy60DayMetric extends ScriptBasedMetric {

    ProductUsageTimeTopCompaniesBy60DayMetric() {
        super(MetricType.PRODUCT_USAGE_TIME_TOP_COMPANIES_BY_60DAY);
    }
