 ...
 */
public class ProductUsageTimeTopUsersBy30DayMetric extends ScriptBasedMetric {

    ProductUsageTimeTopUsersBy30DayMetric() {
        super(MetricType.PRODUCT_USAGE_TIME_TOP_USERS_BY_30DAY);
    }
