...
public class TestScriptNumberProjectDeployedWithJRebel extends BaseTest {

    @Test
    public void testScriptNumberProjectRunnedWithJRebel() throws Exception {
        ...
        events.add(Event.Builder.createProjectBuiltEvent("user1@gmail.com", "ws1", "session1", "project1", "type")
                                .withDate("2013-01-01").withTime("10:05:10").build());
        events.add(Event.Builder.createApplicationCreatedEvent("user1@gmail.com", "ws1", "session1", "project1", "type", "paas")
                                .withDate("2013-01-01").withTime("10:05:20").build());
        events.add(Event.Builder.createProjectDeployedEvent("user1@gmail.com", "ws1", "session1", "project1", "type", "paas")
                                .withDate("2013-01-01").withTime("10:05:30").build());
        ...
        events.add(Event.Builder.createProjectBuiltEvent("user2@gmail.com", "ws2", "session2", "project2", "type")
                                .withDate("2013-01-01").withTime("10:15:10").build());
        events.add(Event.Builder.createApplicationCreatedEvent("user2@gmail.com", "ws2", "session2", "project2", "type", "pass")
                                .withDate("2013-01-01").withTime("10:15:20").build());
        ...
        events.add(Event.Builder.createProjectDeployedEvent("user2@gmail.com", "ws2", "session4", "project3", "type", "pass")
        ...
        events.add(Event.Builder.createProjectBuiltEvent("user2@gmail.com", "ws2", "session6", "project4", "type")
                                .withDate("2013-01-01").withTime("10:35:10").build());
        ...
        LongValueData valueData = (LongValueData)executeAndReturnResult(ScriptType.NUMBER_PROJECT_DEPLOYED_WITH_JREBEL, log, context);
