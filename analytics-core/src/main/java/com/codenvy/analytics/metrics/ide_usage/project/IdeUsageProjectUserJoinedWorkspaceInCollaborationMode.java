...
public class IdeUsageProjectUserJoinedWorkspaceInCollaborationMode extends AbstractIdeUsage {
    ...
    public String getDescription() {
        return "The number of 'Project->UserJoinedWorkspaceinCollaborationMode' operations";
    }
}
