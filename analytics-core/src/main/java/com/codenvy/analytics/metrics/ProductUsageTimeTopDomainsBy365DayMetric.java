 ...
 */
public class ProductUsageTimeTopDomainsBy365DayMetric extends ScriptBasedMetric {

    ProductUsageTimeTopDomainsBy365DayMetric() {
        super(MetricType.PRODUCT_USAGE_TIME_TOP_DOMAINS_BY_365DAY);
    }
