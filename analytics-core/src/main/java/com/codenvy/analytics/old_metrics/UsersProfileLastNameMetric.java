 ...
 */
public class UsersProfileLastNameMetric extends CalculatedMetric {

    UsersProfileLastNameMetric() {
        super(MetricType.USER_PROFILE_LASTNAME, MetricType.USER_UPDATE_PROFILE);
    }
    ...
    public ValueData getValue(Map<String, String> context) throws IOException {
        ...
        return new StringValueData(((UserUpdateProfileMetric)basedMetric).getLastName(valueData));
    }
