...
<html lang="en">
<head>
    <title>Time tracking by workspaces</title>
        ...
        <div>
            <div class="well topFilteringPanel">
                <div id="metric" class="btn-group metric-btns left" targetWidgets="_all">
                    <button class="btn command-btn" default value="time-tracking-workspaces.jsp">Workspaces</button>
                    <button class="btn command-btn" value="time-tracking-users.jsp">Users</button>
                    <button class="btn command-btn" value="time-tracking-sessions.jsp">Sessions</button>
                </div>
            ...
            <div class="hero-unit">
                <div class="single-column-gadget">
                    <div class="view">
                        <div class="tables">
                            <div class="item" id="timeTrackingWorkspaces"></div>
                        </div>
                    </div>
                </div>
            </div>
