 ...
 * from Codenvy S.A..
 */
package com.codenvy.api.subscription.server.payment;
...
public class GuiceBraintreeGateway extends BraintreeGateway {
    ...
    @Inject
    public GuiceBraintreeGateway(@Named(ENVIRONMENT) String environmentName,
                                 @Named(MERCHANT_ID) String merchantId,
