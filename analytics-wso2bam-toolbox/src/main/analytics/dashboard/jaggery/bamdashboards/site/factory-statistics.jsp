...
<div class="container-fluid">
    <div class="row-fluid">
        ...
        <div class="span10">
            ...
            <div class="hero-unit">
                <div id="dashboardWidget" class="single-column-gadget" src="gadgets/factories.jag"></div>
            </div>
        </div>
    </div>
</div>
...
<script>jQuery("#dashboardWidget").load("gadgets/factories.jag?timeGrouping=day");</script>
</body>
</html>
