 ...
 * from Codenvy S.A..
 */
package com.codenvy.analytics.modules.pigexecutor.webapp;
...
public class PigExecutorServiceInitializedListener implements ServletContextListener {
    ...
    public void contextDestroyed(ServletContextEvent sce) {
        PigExecutorServiceImpl.getInstance().shutdown();
    }
}
