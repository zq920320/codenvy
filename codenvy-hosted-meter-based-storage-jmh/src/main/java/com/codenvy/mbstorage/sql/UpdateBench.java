...
public class UpdateBench extends BenchBase {
    ...
    UsageInformer informer;

    @Setup(Level.Iteration)
    public void cleanup() throws ServerException {
        informer =  storage.createMemoryUsedRecord(
    ...
    @Benchmark
    public UsageInformer updateMetrics() throws SQLException, ServerException {
        informer.resourceInUse();
        return  informer;
    }

    @Benchmark
    public UsageInformer updateMetrics3Times() throws SQLException, ServerException {
        informer.resourceInUse();
        informer.resourceInUse();
        informer.resourceInUse();
        return  informer;
