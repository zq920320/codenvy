...
public class TestProjectsDeployedPaas extends BaseTest {
    ...
    public void testExecute() throws Exception {
        ...
        ListListStringValueData value = (ListListStringValueData)executeAndReturnResult(ScriptType.PROJECTS_DEPLOYED_PAAS, log, context);
