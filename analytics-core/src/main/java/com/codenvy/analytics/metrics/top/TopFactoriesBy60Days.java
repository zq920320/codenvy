...
public class TopFactoriesBy60Days extends AbstractTopFactories {

    public TopFactoriesBy60Days() {
        super(MetricType.TOP_FACTORIES_BY_60_DAYS, PassedDaysCount.BY_60_DAYS);
    }
