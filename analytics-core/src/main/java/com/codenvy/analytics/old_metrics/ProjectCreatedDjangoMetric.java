 ...
 */
public class ProjectCreatedDjangoMetric extends CalculatedMetric {

    public ProjectCreatedDjangoMetric() {
        super(MetricType.PROJECT_TYPE_DJANGO, MetricType.PROJECT_CREATED_TYPES);
    }
