...
public class TopCompaniesBy90Days extends AbstractCompaniesTime {

    public TopCompaniesBy90Days() {
        super(MetricType.TOP_COMPANIES_BY_90_DAYS, PassedDaysCount.BY_90_DAYS);
    }
