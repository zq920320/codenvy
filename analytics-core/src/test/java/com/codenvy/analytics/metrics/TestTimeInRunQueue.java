 ...
 */
public class TestTimeInRunQueue extends BaseTest {

    private static final String COLLECTION = TestTimeInRunQueue.class.getSimpleName().toLowerCase();
    ...
    public void prepare() throws Exception {
        ...
        events.add(Event.Builder.createRunQueueWaitingStartedEvent("user1@gmail.com", "ws1", "project", "type", "").withDate(
                "2013-01-01").withTime("19:00:00").build());
        events.add(Event.Builder.createRunQueueWaitingFinishedEvent("user1@gmail.com", "ws1", "project", "type", "").withDate(
                "2013-01-01").withTime("19:06:00").build());

        // user2@gmail.com 2m session
        events.add(
                Event.Builder.createRunQueueWaitingStartedEvent("user2@gmail.com", "ws2", "project", "type", "id1").withDate(
                        "2013-01-01").withTime("19:08:00").build());
        events.add(
                Event.Builder.createRunQueueWaitingFinishedEvent("user2@gmail.com", "ws2", "project", "type", "id1").withDate(
                        "2013-01-01").withTime("19:10:00").build());

        // user1@gmail.com 1m session
        events.add(
                Event.Builder.createRunQueueWaitingStartedEvent("user1@gmail.com", "ws1", "project", "type", "id2").withDate(
                        "2013-01-01").withTime("19:11:00").build());
        events.add(
                Event.Builder.createRunQueueWaitingFinishedEvent("user1@gmail.com", "ws1", "project", "type", "id2").withDate(
                        "2013-01-01").withTime("19:12:00").build());

        // corrupted session events, 'run-started' event is absent
        events.add(Event.Builder.createRunQueueWaitingFinishedEvent("user4@gmail.com", "ws1", "project", "type", "").withDate(
        ...
        builder.put(Parameters.EVENT, "run-queue-waiting");
