...
public class DebugsWithAlwaysOn extends AbstractLongValueResulted {

    public DebugsWithAlwaysOn() {
        super(MetricType.DEBUGS_WITH_ALWAYS_ON, TASK_ID);
    }
    ...
    public String getStorageCollectionName() {
        return getStorageCollectionName(MetricType.DEBUGS);
    }
