 ...
 */
public class UsersProfileFirstNameMetric extends CalculatedMetric {

    UsersProfileFirstNameMetric() {
        super(MetricType.USER_PROFILE_FIRSTNAME, MetricType.USER_UPDATE_PROFILE);
    }
    ...
    public ValueData getValue(Map<String, String> context) throws IOException {
        ...
        return new StringValueData(((UserUpdateProfileMetric)basedMetric).getFirstName(valueData));
    }
