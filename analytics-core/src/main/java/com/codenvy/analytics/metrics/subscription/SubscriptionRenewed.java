...
public class SubscriptionRenewed extends AbstractLongValueResulted {

    public SubscriptionRenewed() {
        super(MetricType.SUBSCRIPTION_RENEWED, ACOUNT);
    }

    /** {@inheritDoc} */
    @Override
    public String getDescription() {
        return "The number of renewed subscriptions";
    }
}
