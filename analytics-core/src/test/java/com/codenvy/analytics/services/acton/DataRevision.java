...
/** 
 * This class is aimed to calculate Act-On report based on log written into the external file. Actual pig-scripts is used for calculation.
 * How-to use:
 ...
 * Example of log body:
 * 
10.9.136.60 2014-02-25 03:00:23,222[ool-7-thread-10]  [INFO ] [o.e.ide.IDESessionService 83]        [dmitry.ndp@gmail.com][dmitryndp][7E346ADB04C23A813B7057F8093C6045] - EVENT#session-started# SESSION-ID#96AB7A86-630A-422C-9E26-601769817228# USER#dmitry.ndp@gmail.com# WS#dmitryndp# WINDOW#ide#
10.93.62.79 2014-02-25 03:00:z47,931[io-8080-exec-13]  [INFO ] [c.c.organization.UserService 197]    [][][] - EVENT#user-update-profile# USER#dmitry.ndp@gmail.com# FIRSTNAME#Dmytro# LASTNAME#ndp-test-30.05# COMPANY## PHONE#0# JOBTITLE##

10.9.136.60 2014-02-25 22:56:14,681[pool-7-thread-5]  [INFO ] [o.e.ide.IDESessionService 110]       [dmitry.ndp@gmail.com][dmitryndp][7E346ADB04C23A813B7057F8093C6045] - EVENT#session-finished# SESSION-ID#96AB7A86-630A-422C-9E26-601769817228# USER#dmitry.ndp@gmail.com# WS#dmitryndp# WINDOW#ide#
 * 
...
//    @Test
    public void revisionByUsingActOn() throws Exception {
        ...
        Parameters.FROM_DATE.put(context, LOG_DATE.replace("-", ""));
        Parameters.TO_DATE.put(context, getCurrentDate().replace("-", ""));        
        
        job.prepareFile(context);
    }
    ...
    private void runScript() throws Exception {
        ...
        Parameters.LOG.put(context, getResourceAsBytes(LOG_DATE, getYerstedayDate()).getAbsolutePath());
