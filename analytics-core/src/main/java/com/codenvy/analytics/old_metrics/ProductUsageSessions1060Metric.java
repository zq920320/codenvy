 ...
 */
public class ProductUsageSessions1060Metric extends CalculatedMetric {

    public ProductUsageSessions1060Metric() {
        super(MetricType.PRODUCT_USAGE_SESSIONS_10_60, MetricType.PRODUCT_USAGE_SESSIONS);
    }
    ...
    public String getDescription() {
        return "The number of sessions in persistent workspaces with duration between 10 and 60 minutes";
    }
