 ...
 * from Codenvy S.A..
 */
package com.codenvy.api.metrics.server.period;

import com.codenvy.api.metrics.server.period.DailyMetricPeriod;
...
public class DailyMetricPeriodTest {

    private DateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss:SSS");
    DailyMetricPeriod dailyBillingPeriod;
    ...
    public void setUp() throws ParseException {
        ...
        dailyBillingPeriod = new DailyMetricPeriod();
