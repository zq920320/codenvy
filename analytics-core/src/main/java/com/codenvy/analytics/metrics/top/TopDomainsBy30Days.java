...
public class TopDomainsBy30Days extends AbstractDomainsTime {

    public TopDomainsBy30Days() {
        super(MetricType.TOP_DOMAINS_BY_30_DAYS, PassedDaysCount.BY_30_DAYS);
    }
