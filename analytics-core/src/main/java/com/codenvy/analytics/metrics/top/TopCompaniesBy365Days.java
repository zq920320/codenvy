...
public class TopCompaniesBy365Days extends AbstractCompaniesTime {

    public TopCompaniesBy365Days() {
        super(MetricType.TOP_COMPANIES_BY_365_DAYS, PassedDaysCount.BY_365_DAYS);
    }
