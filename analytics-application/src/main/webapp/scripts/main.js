...
function Main() {
	...
	var setupButtons = function() {
	    $("#clearSelectionBtn").click(function () {
	        ...
	        var widgetName = $("#filter-by").attr("targetWidget");
	        ...
	        var widgetName = $("#date-range").attr("targetWidget");
	        if (typeof widgetName != "undefined") {
	           reloadWidget(widgetName);
	        }
	    });
	    ...
	    $("#timely-dd button").click(function () {
	        ...
	        var widgetName = $("#timely-dd").attr("targetWidget");
	        if (typeof widgetName != "undefined") {
	           reloadWidget(widgetName);
	        }
	    });
	    ...
	    $("#metric button").click(function () {
	        ...
	        var widgetName = $("#metric").attr("targetWidget");
	        if (typeof widgetName != "undefined") {
	           reloadWidget(widgetName);
	        }
	    });
	...
	function reloadWidget(widgetName, params) {
	    ...
	    loadWidget(widgetName, params, function(data) {
		  ...
		  if (analytics.widgetFactory.isNeedToSaveInHistory(widgetName)) {
	...
	function loadAllWidgets() {
	   ...
	   var widgetNames = analytics.widgetFactory.getWidgetNames();
	...
	function loadWidget(widgetName, params, callback) {
	    ...
	    var view = analytics.widgetFactory.getView(widgetName);
	    ...
	    var model = analytics.widgetFactory.getModel(widgetName);
	    ...
	    var presenter = analytics.widgetFactory.getPresenter(widgetName, view, model);
