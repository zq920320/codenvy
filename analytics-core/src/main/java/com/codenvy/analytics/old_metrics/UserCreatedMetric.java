...
public class UserCreatedMetric extends ValueReadBasedMetric {

    public UserCreatedMetric() {
        super(MetricType.USER_CREATED);
    }
    ...
    public String getDescription() {
        return "The number of created registered users";
    }
}
