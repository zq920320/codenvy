...
function migrateWorkspaces() {
    ...
    print("Found workspaces with config = " + workspaces.find({ "config" : { $exists : true } }).count());
    var count = 0;
    ...
    print("Successfully migrated workspaces = " + count);
}
...
function migrateStacks() {
    ...
    print("Found stacks with config = " + stacks.find({ "workspaceConfig" : { $exists : true } }).count());
    var count = 0;
    ...
    print("Successfully migrated stacks = " + count);
}
...
function migrateFactories() {
    ...
    print("Found factories with workspace = " + factories.find({ "factory.workspace" : { $exists : true } }).count());
    var count = 0;
    ...
    print("Successfully migrated factories = " + count);
}
