...
public class ProductUsageTime01Metric extends CalculatedMetric {

    public ProductUsageTime01Metric() {
        super(MetricType.PRODUCT_USAGE_TIME_0_1, MetricType.PRODUCT_USAGE_SESSIONS);
    }
