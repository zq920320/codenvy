...
public class InviteService {
    ...
    public Response createInvitation(@PathParam("ws-id") String workspaceId, @Context SecurityContext security,
        ...
        try {
            ...
            User user = userDao.getByAlias(mailRecipient);
        ...
        } catch (UserException | MembershipException | IOException | UserProfileException | WorkspaceException | MessagingException e) {
