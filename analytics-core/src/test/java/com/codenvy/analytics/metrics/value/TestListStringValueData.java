...
public class TestListStringValueData extends BaseTest {
    ...
    public void testStoreLoad() throws Exception {
        FSValueDataManager.storeValue(expectedValueData, MetricType.ACTIVITY, uuid);
        assertEquals(FSValueDataManager.loadValue(MetricType.ACTIVITY, uuid), expectedValueData);
    }
