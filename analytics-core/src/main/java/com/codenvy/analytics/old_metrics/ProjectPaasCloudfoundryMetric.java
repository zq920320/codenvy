...
public class ProjectPaasCloudfoundryMetric extends CalculatedMetric {

    ProjectPaasCloudfoundryMetric() {
        super(MetricType.PROJECT_PAAS_CLOUDFOUNDRY, MetricType.PROJECT_DEPLOYED_TYPES);
    }

    /** {@inheritDoc} */
    @Override
    public ValueData getValue(Map<String, String> context) throws IOException {
        Parameters.PARAM.put(context, "CloudFoundry");
