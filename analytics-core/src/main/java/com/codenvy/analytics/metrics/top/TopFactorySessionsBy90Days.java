...
public class TopFactorySessionsBy90Days extends AbstractTopSessions {

    public TopFactorySessionsBy90Days() {
        super(MetricType.TOP_FACTORY_SESSIONS_BY_90_DAYS, PassedDaysCount.BY_90_DAYS);
    }
