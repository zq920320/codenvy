...
public abstract class AbstractFailedFactorySessions extends ReadBasedMetric implements ReadBasedExpandable {

    public AbstractFailedFactorySessions(MetricType type) {
        super(type);
    }
