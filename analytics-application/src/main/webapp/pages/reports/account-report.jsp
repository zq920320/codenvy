...
<jsp:include page="/inclusions/top-menu/top-menu.jsp">
    ...
    <jsp:param name="selectedMenuItemId" value="topmenu-reports-account_report"/>
</jsp:include>
            ...
            <div class="well topFilteringPanel">
                <div id="filter-by" class="left" targetWidgets="_all">
                    ...
                    <div class="collabsiblePanelBody">
                        <table>
                            <tr>
                                <td><label for="input-account">Account:</label></td>
                                <td><div class="filter-item">
                                    <input type="text" id="input-account" name="account_id" class="text-box" />
                                </div></td>
                            </tr>
                            <tr>
