...
public class TestScriptNumberProjectRunnedWithJRebel extends BaseTest {
    ...
    public void testScriptNumberProjectRunnedWithJRebel() throws Exception {
        ...
        events.add(Event.Builder.createRunStartedEvent("user1@gmail.com", "ws1", "project1", "type")
        ...
        events.add(Event.Builder.createRunStartedEvent("user2@gmail.com", "ws2", "project2", "type")
                                .withDate("2013-01-01").withTime("10:15:00").build());
        events.add(Event.Builder.createRunStartedEvent("user2@gmail.com", "ws2", "project2", "type")
                                .withDate("2013-01-01").withTime("10:17:00").build());

        events.add(Event.Builder.createRunStartedEvent("user2@gmail.com", "ws2", "project3", "type")
        ...
        events.add(Event.Builder.createRunStartedEvent("user2@gmail.com", "ws2", "project4", "type")
                                .withDate("2013-01-01").withTime("10:30:00").build());
        ...
        LongValueData valueData = (LongValueData)executeAndReturnResult(ScriptType.NUMBER_PROJECT_RUNNED_WITH_JREBEL, log, context);
