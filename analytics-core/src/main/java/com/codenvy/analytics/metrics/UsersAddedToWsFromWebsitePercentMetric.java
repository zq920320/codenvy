 ...
 */
public class UsersAddedToWsFromWebsitePercentMetric extends CalculateBasedMetric {
    ...
    protected ValueData evaluate(Map<String, String> context) throws IOException {
        ...
        int number = filter.size(MetricFilter.FILTER_USER_ADDED_FROM, UsersAddedToWorkspaceListMetric.WEBSITE);
