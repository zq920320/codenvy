...
import static com.codenvy.api.metrics.server.WorkspaceLockEvent.EventType;
...
public class WorkspaceLockWebSocketMessenger implements EventSubscriber<WorkspaceLockEvent> {
    private static final Logger LOG = LoggerFactory.getLogger(WorkspaceLockWebSocketMessenger.class);
