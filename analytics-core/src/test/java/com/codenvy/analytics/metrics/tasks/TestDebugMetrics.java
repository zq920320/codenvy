...
public class TestDebugMetrics extends BaseTest {
    ...
    @Test
    public void testDebugsFinishedByUser() throws Exception {
        Metric metric = MetricFactory.getMetric(MetricType.DEBUGS_FINISHED_BY_USER);
    ...
    @Test
    public void testDebugsFinishedByTimeout() throws Exception {
        Metric metric = MetricFactory.getMetric(MetricType.DEBUGS_FINISHED_BY_TIMEOUT);
    ...
    @Test
    public void testDebugsWithAlwaysOn() throws Exception {
        Metric metric = MetricFactory.getMetric(MetricType.DEBUGS_WITH_ALWAYS_ON);
    ...
    @Test
    public void testDebugsWithTimeout() throws Exception {
        Metric metric = MetricFactory.getMetric(MetricType.DEBUGS_WITH_TIMEOUT);
    ...
    public void testGigabyteRamHours() throws Exception {
        Metric metric = MetricFactory.getMetric(MetricType.DEBUGS_GIGABYTE_RAM_HOURS);
    ...
    public void testMemoryUsage() throws Exception {
        Metric metric = MetricFactory.getMetric(MetricType.DEBUGS_MEMORY_USAGE);
    ...
    @Test
    public void testDebugs() throws Exception {
        Metric metric = MetricFactory.getMetric(MetricType.DEBUGS);
    ...
    @Test
    public void testDebugsFinished() throws Exception {
        Metric metric = MetricFactory.getMetric(MetricType.DEBUGS_FINISHED);
    ...
    @Test
    public void testDebugsTime() throws Exception {
        Metric metric = MetricFactory.getMetric(MetricType.DEBUGS_TIME);
