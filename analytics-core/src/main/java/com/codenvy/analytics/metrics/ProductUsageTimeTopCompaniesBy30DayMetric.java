 ...
 */
public class ProductUsageTimeTopCompaniesBy30DayMetric extends ScriptBasedMetric {

    ProductUsageTimeTopCompaniesBy30DayMetric() {
        super(MetricType.PRODUCT_USAGE_TIME_TOP_COMPANIES_BY_30DAY);
    }
