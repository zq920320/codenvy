...
<jsp:include page="/inclusions/top-menu/top-menu.jsp">
    <jsp:param name="selectedMenuItemId" value="topmenu-accounts"/>
</jsp:include>
                        ...
                        <table>
                            <tr>
                               ...
                               <td><div class="filter-item">
                                   <input type="text" id="input-id" name="id" class="text-box" />
                               </div></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                               <td><label for="input-subscription">Subscription:</label></td>
                               <td><div class="filter-item">
                                   <input type="text" id="input-subscription" name="subscription" class="text-box" />
                               </div></td>
                            </tr>
                            <tr>
                               <td></td>
