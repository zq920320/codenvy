...
<jsp:include page="/inclusions/top-menu.jsp">
    ...
    <jsp:param name="selectedMenuItemId" value="topmenu-reports-collaboration_report"/>
</jsp:include>
        ...
        <div>
            ...
            <div class="single-column-gadget full-width">
                <div class="view">
                    <div class="tables">
                        <div class="item">
                            <div class="header">Collaboration Report</div>
                            <div class="body" id="collaborationReport"></div>
                        </div>
                    </div>
                </div>
            </div>            
