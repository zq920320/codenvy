...
-- indexes
CREATE UNIQUE INDEX index_license_licensetype_actiontype ON license (license_type, action_type);
--------------------------------------------------------------------------------
...
CREATE TABLE license_attributes (
    ...
    CONSTRAINT unq_license_attributes_0 UNIQUE (id, name)
);
-- indexes
CREATE UNIQUE INDEX index_license_attributes_id_value ON license_attributes (id, name);
-- constraints
ALTER TABLE license_attributes ADD CONSTRAINT fk_license_attributes_id FOREIGN KEY (id) REFERENCES license (id);
--------------------------------------------------------------------------------
