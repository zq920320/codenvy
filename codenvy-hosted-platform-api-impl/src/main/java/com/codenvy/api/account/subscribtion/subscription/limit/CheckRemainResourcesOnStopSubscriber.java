...
public class CheckRemainResourcesOnStopSubscriber implements EventSubscriber<RunnerEvent> {
    ...
    @Inject
    public CheckRemainResourcesOnStopSubscriber(EventService eventService, WorkspaceDao workspaceDao,
    ...
    private void checkRemainResources(RunnerEvent event) {
        try {
            ...
            LOG.error("Error check remaining resources {} in workspace {} .", event.getProcessId(),
                      event.getWorkspace());
        }
    }
}
