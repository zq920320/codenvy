 ...
 * @author Oleksii Orel
 */
public class SubscriptionIndicatorAction extends Action implements CustomComponentAction {
    ...
    @Inject
    public SubscriptionIndicatorAction(SubscriptionsResources resources, AnalyticsEventLogger eventLogger) {
        panel = new FlowPanel();
