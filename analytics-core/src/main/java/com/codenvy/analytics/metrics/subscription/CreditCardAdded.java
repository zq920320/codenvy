...
public class CreditCardAdded extends AbstractAccountActiveEntities {

    public CreditCardAdded() {
        super(MetricType.CREDIT_CARD_ADDED, ACOUNT);
    }

    /** {@inheritDoc} */
    @Override
    public String getDescription() {
        return "The number of added credit cards";
    }
}
