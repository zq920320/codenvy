 ...
 */
public class ProductUsageTimeTopCompaniesByLifeTimeMetric extends ScriptBasedMetric {

    ProductUsageTimeTopCompaniesByLifeTimeMetric() {
        super(MetricType.PRODUCT_USAGE_TIME_TOP_COMPANIES_BY_LIFETIME);
    }
