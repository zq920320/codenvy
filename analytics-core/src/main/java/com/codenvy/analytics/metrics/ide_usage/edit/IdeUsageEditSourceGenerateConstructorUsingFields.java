...
public class IdeUsageEditSourceGenerateConstructorUsingFields extends AbstractIdeUsage {
    ...
    public String getDescription() {
        return "The number of 'Edit->Source->GenerateConstructorUsingFields' operations";
    }
}
