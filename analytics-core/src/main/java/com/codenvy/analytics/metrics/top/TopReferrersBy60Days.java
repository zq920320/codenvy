...
public class TopReferrersBy60Days extends AbstractTopReferrers {

    public TopReferrersBy60Days() {
        super(MetricType.TOP_REFERRERS_BY_60_DAYS, PassedDaysCount.BY_60_DAYS);
    }
