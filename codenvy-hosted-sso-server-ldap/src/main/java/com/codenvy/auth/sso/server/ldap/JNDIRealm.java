...
public class JNDIRealm {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(JNDIRealm.class);
    ...
    protected final String derefAliases;


    protected final String protocol;


    protected final boolean adCompat;


    protected final String referrals;


    protected final String userBase;


    protected final String userSearch;


    protected final boolean userSubtree;


    protected final String userRoleAttribute;


    protected final String userPattern;


    protected final String roleBase;


    protected final String userRoleName;


    protected final String roleName;


    protected final boolean roleSubtree;


    protected final boolean roleNested;


    protected final boolean roleSearchAsUser;


    protected final String alternateURL;


    protected final String commonRole;


    protected final String connectionTimeout;
    ...
    protected final boolean useDelegatedCredential;


    protected final String spnegoDelegationQop;

    /**
     * The MessageFormat object associated with the current
     * <code>roleBase</code>.
     */
    protected final MessageFormat roleBaseFormat;
     ...
     */
    protected final MessageFormat roleFormat;

    /**
     * An array of MessageFormat objects associated with the current
     * <code>userPatternArray</code>.
     */
    protected final MessageFormat[] userPatternFormatArray;
     ...
     * This is similar to userPattern, but allows for multiple searches for a user.
     */
    protected final String[] userPatternArray;

    /**
     * The MessageFormat object associated with the current
     * <code>userSearch</code>.
     */
    protected final MessageFormat userSearchFormat;
     ...
     *         - The JNDI context factory used to acquire our InitialContext.  By default, assumes use of an LDAP server using the standard
     *         JNDI LDAP provider.
     * @param derefAliases
     ...
     */
    @Inject
    public JNDIRealm(@Named("auth.sysldap." + Context.PROVIDER_URL) String connectionURL,
                     @Nullable @Named("auth.sysldap.alternate." + Context.PROVIDER_URL) String alternateURL,
                     @Nullable @Named("auth.sysldap." + Context.SECURITY_PRINCIPAL) String connectionName,
                     @Nullable @Named("auth.sysldap." + Context.SECURITY_CREDENTIALS) String connectionPassword,
                     @Nullable @Named("auth.sysldap." + Context.SECURITY_AUTHENTICATION) String authentication,
                     @Nullable @Named("auth.sysldap." + Context.SECURITY_PROTOCOL) String protocol,
                     @Nullable @Named("auth.sysldap." + Context.REFERRAL) String referrals,
                     @Nullable @Named("auth.sysldap." + DEREF_ALIASES) String derefAliases,
                     @Nullable @Named("auth.sysldap." + Context.INITIAL_CONTEXT_FACTORY) String contextFactory,
                     @Nullable @Named("auth.sysldap.com.sun.jndi.ldap.connect.timeout") String connectionTimeout,
                     @Nullable @Named("auth.sysldap.ad_compat") String adCompat,
                     @Nullable @Named("auth.sysldap.common_role") String commonRole,
                     @Nullable @Named("auth.sysldap.connection.attempt") String connectionAttempt,
                     @Nullable @Named("auth.sysldap.role.base") String roleBase,
                     @Nullable @Named("auth.sysldap.role.name") String roleName,
                     @Nullable @Named("auth.sysldap.role.nested") String roleNested,
                     @Nullable @Named("auth.sysldap.role.search") String roleSearch,
                     @Nullable @Named("auth.sysldap.role.subtree") String roleSubtree,
                     @Nullable @Named("auth.sysldap.role.size_limit") String sizeLimit,
                     @Nullable @Named("auth.sysldap.role.time_limit") String timeLimit,
                     @Nullable @Named("auth.sysldap.role.search_as_user") String roleSearchAsUser,
                     @Nullable @Named("auth.sysldap.javax.security.sasl.qop") String spnegoDelegationQop,
                     @Nullable @Named("auth.sysldap.use_delegated_credential") String useDelegatedCredential,
                     @Nullable @Named("auth.sysldap.user_base") String userBase,
                     @Nullable @Named("auth.sysldap.user_pattern") String userPattern,
                     @Nullable @Named("auth.sysldap.user_role_attribute") String userRoleAttribute,
                     @Nullable @Named("auth.sysldap.user_role_name") String userRoleName,
                     @Nullable @Named("auth.sysldap.user_search") String userSearch,
                     @Nullable @Named("auth.sysldap.user_subtree") String userSubtree
        ...
        this.contextFactory = contextFactory == null ? "com.sun.jndi.ldap.LdapCtxFactory" : contextFactory;
        this.connectionTimeout = connectionTimeout == null ? "5000" : connectionTimeout;
        this.adCompat = adCompat == null ? false : Boolean.parseBoolean(adCompat);
        this.commonRole = commonRole;
        this.connectionAttempt = connectionAttempt == null ? 0 : Integer.parseInt(connectionAttempt);
        ...
        this.roleNested = roleNested == null ? false : Boolean.parseBoolean(roleNested);
        this.roleFormat = roleSearch == null ? null : new MessageFormat(roleSearch);
        this.roleSubtree = roleSubtree == null ? false : Boolean.parseBoolean(roleSubtree);
        this.sizeLimit = sizeLimit == null ? 0 : Long.parseLong(sizeLimit);
        this.spnegoDelegationQop = spnegoDelegationQop == null ? "auth-conf" : spnegoDelegationQop;
        this.timeLimit = timeLimit == null ? 0 : Integer.parseInt(timeLimit);
        this.roleSearchAsUser = roleSearchAsUser == null ? false : Boolean.parseBoolean(roleSearchAsUser);
        this.useDelegatedCredential = useDelegatedCredential == null ? true : Boolean.parseBoolean(useDelegatedCredential);
        this.userBase = userBase == null ? "" : userBase;
        ...
        if (userPattern == null) {
            ...
            for (int i = 0; i < len; i++) {
                this.userPatternFormatArray[i] =
                        new MessageFormat(this.userPatternArray[i]);
            }
        }
        ...
        this.userSubtree = userSubtree == null ? false : Boolean.parseBoolean(userSubtree);
     ...
     */
    public GenericPrincipal authenticate(String username, String credentials) {
        ...
        try {
            ...
            try {
                ...
                */
                ...
                LOG.info("Exception performing authentication. Retrying...", e);
            ...
            LOG.error("Exception performing authentication", e);
            ...
            if (LOG.isDebugEnabled())
                LOG.debug("Returning null principal.");
            return (null);
     ...
     */
    public synchronized GenericPrincipal authenticate(DirContext context,
                                                      String username,
                                                      String credentials)
            throws NamingException {
        ...
        if (username == null || username.equals("")
            ...
            if (LOG.isDebugEnabled())
                LOG.debug("username null or empty: returning null principal.");
            return (null);
        }
                    ...
                    try {
                        ...
                        if (checkCredentials(context, user, credentials)) {
                            ...
                            if (LOG.isDebugEnabled()) {
                                ...
                                while (it.hasNext()) {
                                    LOG.debug("Found role: " + it.next());
                                }
                            }
                            return (new GenericPrincipal(username, user.getDN(), roles));
                        }
                    } catch (InvalidNameException ine) {
                        // Log the problem for posterity
                        LOG.warn("Exception performing authentication", ine);
    ...
    protected User getUserByPattern(DirContext context,
        ...
        return new User(username, dn, null, roles, userRoleAttrValue);
    }
    ...
    protected boolean checkCredentials(DirContext context,
        ...
        if (LOG.isTraceEnabled()) {
            if (validated) {
                LOG.trace("Username {0} successfully authenticated",
                          user.getUserName());
            } else {
                LOG.trace("Username {0} NOT successfully authenticated",
                          user.getUserName());
            }
        }
        return (validated);
    ...
    protected List<String> getRoles(DirContext context, User user)
        ...
        if (LOG.isTraceEnabled()) {
            LOG.trace("  Found " + list.size() + " user internal roles");
            for (int i = 0; i < list.size(); i++)
                LOG.trace("  Found user internal role " + list.get(i));
        }
        ...
        if (LOG.isTraceEnabled()) {
            LOG.trace("  Found " + keys.size() + " direct roles");
            for (String key : keys) {
                LOG.trace("  Found direct role " + key + " -> " + groupMap.get(key));
            }
        }
        ...
        if (getRoleNested()) {
            ...
            while (!newGroups.isEmpty()) {
                ...
                for (Entry<String, String> group : newGroups.entrySet()) {
                    ...
                    if (LOG.isTraceEnabled()) {
                        LOG.trace("Perform a nested group search with base " + roleBase + " and filter " + filter);
                    }
                    ...
                    try {
                        while (results.hasMore()) {
                            ...
                            if (name != null && dname != null && !groupMap.keySet().contains(dname)) {
                                ...
                                if (LOG.isTraceEnabled()) {
                                    LOG.trace("  Found nested role " + dname + " -> " + name);
                                }
    ...
    protected void close(DirContext context) {
        ...
        try {
            ...
            LOG.error("Exception closing directory server connection", e);
        }
        this.context = null;
    ...
    public GenericPrincipal getPrincipal(String username) {
    ...
    protected GenericPrincipal getPrincipal(String username,
        ...
        try {
            ...
            try {
                ...
                // log the exception so we know it's there.
                LOG.warn("Exception performing authentication. Retrying...");
            ...
            // Log the problem for posterity
            LOG.warn("Exception performing authentication", e);
            LOG.debug(e.getLocalizedMessage(), e);
     ...
     * Return the Principal associated with the given user name.
     */
    protected synchronized GenericPrincipal getPrincipal(DirContext context,
        ...
        if (user != null) {
            return new GenericPrincipal(user.getUserName(), user.getDN(), roles);
        }
    ...
    protected void startInternal() {
        ...
        try {
            ...
            throw new RuntimeException("Exception opening directory server connection", e);
        }
    ...
    protected String getDistinguishedName(DirContext context, String base,
        ...
        if (result.isRelative()) {
            if (LOG.isTraceEnabled()) {
                LOG.trace("  search returned relative name: " +
                          result.getName());
            }
            ...
            if (LOG.isTraceEnabled())
                LOG.trace("  search returned absolute name: " +
                          result.getName());
            try {
    ...
    public class GenericPrincipal implements Principal {
        ...
        /**
         * Construct a new Principal, a for the
         * specified username  with the specified role names
         * (as Strings).
         *
         * @param name
         ...
         */
        public GenericPrincipal(String name, String dn, List<String> roles) {
