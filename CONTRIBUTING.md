Contributing to Codenvy
=======================

Before Submitting an Issue
--------------------------
Check that [our issue database](https://github.com/codenvy/codenvy/issues)
...
-------------------------
If you are interested in fixing issues and contributing directly to the code base, please get involved with [Eclipse Che](https://github.com/eclipse/che/).
