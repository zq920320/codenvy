...
public enum MetricType {
    ...
    TOP_FACTORY_SESSIONS_BY_1_DAY,
    TOP_FACTORY_SESSIONS_BY_7_DAYS,
    TOP_FACTORY_SESSIONS_BY_30_DAYS,
    TOP_FACTORY_SESSIONS_BY_60_DAYS,
    TOP_FACTORY_SESSIONS_BY_90_DAYS,
    TOP_FACTORY_SESSIONS_BY_365_DAYS,
    TOP_FACTORY_SESSIONS_BY_LIFETIME,

    TOP_FACTORIES_BY_1_DAY,
    TOP_FACTORIES_BY_7_DAYS,
    TOP_FACTORIES_BY_30_DAYS,
    TOP_FACTORIES_BY_60_DAYS,
    TOP_FACTORIES_BY_90_DAYS,
    TOP_FACTORIES_BY_365_DAYS,
    TOP_FACTORIES_BY_LIFETIME,

    TOP_REFERRERS_BY_1_DAY,
    TOP_REFERRERS_BY_7_DAYS,
    TOP_REFERRERS_BY_30_DAYS,
    TOP_REFERRERS_BY_60_DAYS,
    TOP_REFERRERS_BY_90_DAYS,
    TOP_REFERRERS_BY_365_DAYS,
    TOP_REFERRERS_BY_LIFETIME,

    TOP_USERS_BY_1_DAY,
    TOP_USERS_BY_7_DAYS,
    TOP_USERS_BY_30_DAYS,
    TOP_USERS_BY_60_DAYS,
    TOP_USERS_BY_90_DAYS,
    TOP_USERS_BY_365_DAYS,
    TOP_USERS_BY_LIFETIME,

    TOP_DOMAINS_BY_1_DAY,
    TOP_DOMAINS_BY_7_DAYS,
    TOP_DOMAINS_BY_30_DAYS,
    TOP_DOMAINS_BY_60_DAYS,
    TOP_DOMAINS_BY_90_DAYS,
    TOP_DOMAINS_BY_365_DAYS,
    TOP_DOMAINS_BY_LIFETIME,

    TOP_COMPANIES_BY_1_DAY,
    TOP_COMPANIES_BY_7_DAYS,
    TOP_COMPANIES_BY_30_DAYS,
    TOP_COMPANIES_BY_60_DAYS,
    TOP_COMPANIES_BY_90_DAYS,
    TOP_COMPANIES_BY_365_DAYS,
