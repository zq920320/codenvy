...
<jsp:include page="/inclusions/top-menu/top-menu.jsp">
    ...
    <jsp:param name="selectedMenuItemId" value="topmenu-reports-runner_report"/>
</jsp:include>
            ...
            <div class="well topFilteringPanel">
                <div id="filter-by" class="left" targetWidgets="_all">
                    ...
                    <div class="collabsiblePanelBody">
                        <table>
                            <tr>
                               <td><label for="input-factory">Workspace:</label></td>
                               <td><div class="filter-item">
                                   <input type="text" id="input-worksapce" name="ws" class="text-box" />
                               </div></td>
                            </tr>
                            <tr>
