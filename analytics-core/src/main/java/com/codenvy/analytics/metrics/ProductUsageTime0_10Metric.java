 ...
 */
public class ProductUsageTime0_10Metric extends CalculateBasedMetric {

    private final Metric basedMetric;

    public ProductUsageTime0_10Metric() throws IOException {
        super(MetricType.PRODUCT_USAGE_TIME_0_10);
    ...
    protected ValueData evaluate(Map<String, String> context) throws IOException {
        ...
        return new LongValueData(filter.getUsageTime(0, true, 10 * 60, false));
    }
}
