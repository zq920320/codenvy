 ...
 */
public class UsersCreatedRelativelyToNewUsersProjectsNumberMetric extends CalculateBasedMetric {

    private final Metric createdUsersMetric;
    private final Metric createdProjectsMetric;

    UsersCreatedRelativelyToNewUsersProjectsNumberMetric() throws IOException {
        super(MetricType.USERS_CREATED_PROJECTS_RELATIVELY_TO_NEW_USERS_PERCENT);
    ...
    protected ValueData evaluate(Map<String, String> context) throws IOException {
        ...
        return new DoubleValueData(100D * count / usersCreated.size());
    }
}
