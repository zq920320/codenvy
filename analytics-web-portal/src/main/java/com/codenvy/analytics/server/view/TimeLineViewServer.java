 ...
 */
public class TimeLineViewServer {
    ...
    public static final String        ANALYTICS_TIME_LIVE_VIEW          = System.getProperty(ANALYTICS_TIME_LINE_VIEW_PROPERTY);
     ...
     */
    public TimeLineViewServer(Map<String, String> initContext) {
