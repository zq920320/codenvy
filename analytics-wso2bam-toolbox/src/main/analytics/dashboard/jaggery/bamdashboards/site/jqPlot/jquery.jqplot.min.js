    ...
    function N() {
        ...
        this.draw = function () {
            if (this.drawIfHidden || this.target.is(":visible")) {
                ...
                var at = (this.legend.placement == "outsideGrid") ? {top: this.title.getHeight(), left: 0, right: 0, bottom: 0} : this._gridPadding;
                        ...
                        if (aI.show) {
                            for (var aO = 0; aO < aI.gridData.length; aO++) {
                                ...
                                if (aQ <= aK[2] && (aQ <= aM || aM == null)) {
                                    aM = aQ;
                                    az = {seriesIndex: aP, pointIndex: aO, gridData: aK, data: aI.data[aO]}
                                }
                            }
                            if (az != null) {
                                return az
                    ...
                    case H.jqplot.LineRenderer:
                        ...
                        if (aI.show) {
                            if ((aI.fill || (aI.renderer.bands.show && aI.renderer.bands.fill)) && (!ag.plugins.highlighter || !ag.plugins.highlighter.show)) {
                                ...
                                if (aq) {
                                    return{seriesIndex: aP, pointIndex: null, gridData: aI.gridData, data: aI.data, points: aI._areaPoints}
                                }
                                break
                            } else {
                                    ...
                                    if (aJ.constructor == H.jqplot.OHLCRenderer) {
                                        if (aJ.candleStick) {
                                            ...
                                            if (aD >= aK[0] - aJ._bodyWidth / 2 && aD <= aK[0] + aJ._bodyWidth / 2 && aC >= ao(aI.data[aO][2]) && aC <= ao(aI.data[aO][3])) {
                                                return{seriesIndex: aP, pointIndex: aO, gridData: aK, data: aI.data[aO]}
                                            }
                                        } else {
                                            if (!aJ.hlc) {
                                                var ao = aI._yaxis.series_u2p;
            ...
            for (var aT = 0; aT < this.numberTicks; aT++) {
                ...
                if (aT < this.numberTicks - 1) {
                    for (var aS = 0; aS < this.minorTicks; aS++) {
                        ...
                        a0 = H.extend(true, {}, this.tickOptions, {name: this.name, value: aW, label: "", isMinorTick: true});
